    ...
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={rankings} layout="vertical" margin={{ left: 0, right: 10, top: 5, bottom: 5 }}>
        ...
        <Tooltip
          ...
          formatter={(value: any, name: any) => [`${Math.round(value)} pts`, name === "bat" ? "Batting" : "Bowling"]}
        />
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={top10} layout="vertical" margin={{ left: 5, right: 10, top: 5, bottom: 5 }}>
        ...
        <Tooltip
          contentStyle={{ background: "#1f2937", border: "1px solid #374151", borderRadius: 8, fontSize: 12 }}
          formatter={(value: any) => [`${Math.round(value)} pts`, "Expected"]}
        />
  ...
  return (
    <ResponsiveContainer width="100%" height={160}>
      <BarChart data={chartData} margin={{ left: 0, right: 10, top: 5, bottom: 5 }}>
        ...
        <Tooltip
          contentStyle={{ background: "#1f2937", border: "1px solid #374151", borderRadius: 8, fontSize: 12 }}
          formatter={(value: any, _: any, entry: any) => [`${value} pts (${entry.payload.count} players)`]}
        />
